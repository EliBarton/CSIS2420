 ...
 * It uses the Java API Stack to keep track of the toys.
 * 
 * @author eli
 *
 */
...
public class Application2 {
	...
	public static void main(String[] args) throws IOException {
		Stack<String> sleigh = new Stack<String>();
	...
	private static void MainMenu(Stack<String> sleigh) throws IOException {
		...
		if (input.startsWith("5")){
			System.out.println(sleigh.toString());
			MainMenu(sleigh);
		}
	...
	private static void factory(Stack<String> sleigh) throws IOException {
		System.out.println("");
		System.out.println("");
	...
	private static void CheckList(Stack<String> sleigh) throws IOException {
		System.out.println("");
		System.out.println("");
	...
	private static void AskKid(Stack<String> sleigh) throws IOException {
		System.out.println("");
		System.out.println("");
	...
	private static void CheckPresents(Stack<String> sleigh) {
		System.out.println("");
		System.out.println("");
		System.out.println("");
	...
	/**
	 * This method runs whenever santa runs out of presents before he's done giving them out.
	 */
